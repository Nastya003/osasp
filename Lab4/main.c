...
void handle_pr6(int sig) {
    ...
    if (sig == SIGUSR2) {
        ...
        printf("%d %d closed after %d SIGUSR2\n", getpid(), getppid(), countSent);
        exit(0);
    }
}
